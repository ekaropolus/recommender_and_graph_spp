...
REQUIRED_PATHS = [
    ...
    "reproducible-scholarship/data-statement.md",
    "reproducible-scholarship/graph-schema.md",
    "reproducible-scholarship/methodology.md",
    "reproducible-scholarship/outputs/README.md",
    "reproducible-scholarship/outputs/graph/nodes.csv",
    "reproducible-scholarship/outputs/graph/edges.csv",
    "reproducible-scholarship/outputs/manifests/run-manifest.json",
    "reproducible-scholarship/outputs/manifests/summary.json",
    "reproducible-scholarship/outputs/tables/asdi_datasets.csv",
    "reproducible-scholarship/outputs/tables/file_inventory.csv",
    "reproducible-scholarship/outputs/tables/sdg_policy_indicators.csv",
    "reproducible-scholarship/run-manifest-template.json",
    "scripts/build_reproducible_scholarship.py",
    "scripts/test_reproducible_scholarship.py",
    "ASDI Tables",
